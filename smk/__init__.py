...
from smk.forms import ContactForm
...
def create_app(config_name=None):
    ...
    #----------------------------------------------------
    with open('smk/static/js/db.json') as f:
        box_db = Box(load(f))

    # apply the blueprints to the app
    from . import auth, blog, links
        ...
        if form.is_submitted():
            if form.validate():
                ...
                msg = Message(  subject = "Got your message!", 
                                sender=('Shawn Kristek','shawnkristek@gmail.com'), 
                                recipients=[form.email.data],
                                cc=['shawnkristek@gmail.com'],
                                reply_to='shawnkristek@gmail.com'
                                )
                msg.body = """
                Dear %s,
                ...
                Shawn Kristek
                Software Engineer
                shawnkristek@gmail.com""" % (form.name.data, form.subject.data, form.message.data)
                mail.send(msg)
    ...
    @app.route('/resume')
    def resume():
        return send_from_directory('static',filename='files/SKristek - Software Engineer.pdf')
